...
<p align="center">Automatically generate project documentation to boost developer efficiency 🚀</p>
...
2. **Output after running the generate command**:  
   ...
   📚 Collecting key code snippets (maximum 5 files)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
⚠️ The target project path must contain valid code files (not in ignore patterns), otherwise it will prompt "No valid files found" and exit.
⚠️ Code analysis limits: Maximum 100 lines per file, maximum 5 files analyzed.
⚠️ The translation feature requires first generating a Chinese README.md using the `generate` command, otherwise the translation command will report an error.
⚠️ To add chapters, add corresponding usable prompts in the zh.js file.
...
✅ Auto-detect .gitignore file for automatic filtering

✅ Specify output folder for generation

✅ Chapter configuration

✅ GitHub library detection
