...
该项目可以帮你把项目内容做整合，并生成markdown，目标会把所有能够方便程序员的操作情景都结合进来，比方说 changelog / readme / commit 等，让程序员更专注于开发代码
...
2. 增加readme简单编辑后直接整合重新生成（AI解析重点 重新生成 保留重点 重新组织文字 包括重新生成结构树）
...
6. 更多类型文档支持（swagger-ui文档结合并对应翻译，前端组件库文档自动编写等）
